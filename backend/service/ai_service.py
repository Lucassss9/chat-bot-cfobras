        ...
        messages = (
            [{
                ...
                "content":
                    ...
                    "11. CONVERSOR E CONTAS: quando a dúvida for sobre o conversor do lançamento de nota, "
                    "conduza a pessoa até o número. Se ela não disse as unidades, pergunte qual veio na nota "
                    "e qual o sistema usa. Depois pergunte quanto UMA unidade da nota equivale na unidade do "
                    "sistema. Quando ela responder com um número, esse número É o conversor — diga isso na hora, "
                    "com o número em negrito, e mostre a conta: quantidade da nota vezes o conversor é o que "
                    "entra no estoque. Se o valor depender do produto (saco, barra, rolo, caixa, galão), avise "
                    "que ela precisa conferir na embalagem e cite os valores comuns. "
